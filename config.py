...
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 900000000000000000))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/SSKDMK/Spotify_Music",
)
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+_FxxqiiJRLdjMGNl")
...
PLAYLIST_FETCH_LIMIT = int(getenv("PLAYLIST_FETCH_LIMIT", "200000000000000005"))

SONG_DOWNLOAD_DURATION = int(getenv("SONG_DOWNLOAD_DURATION_LIMIT", "180000000000000"))
SONG_DOWNLOAD_DURATION_LIMIT = int(getenv("SONG_DOWNLOAD_DURATION_LIMIT", "20000000000000000"))

# Telegram audio and video file size limit (in bytes)
TG_AUDIO_FILESIZE_LIMIT = int(getenv("TG_AUDIO_FILESIZE_LIMIT", 104857600000000000000000))
TG_VIDEO_FILESIZE_LIMIT = int(getenv("TG_VIDEO_FILESIZE_LIMIT", 10737418000000000000000000000000000024))
